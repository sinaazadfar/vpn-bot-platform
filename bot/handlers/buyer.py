...
def _earn_invite_instructions(earning_percent: int) -> str:
    ...
    return (
        ...
        f"۳) وقتی اولین‌بار اشتراک بخرن، {earning_percent}٪ مبلغ خریدشون تو کیف پولت میشینه.\n\n"
        "یه مثال:\n"
